...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(
        ...
        self.actions = Struct(
            ...
            fileMenuActions=(open, open_dir, save, save_as, close, quit),
            beginner=(),
            advanced=(),
    ...
    def focus_request(self, unfocus=False):
        ...
        margin_x, margin_y = (scroll_area_w - shape_w) / 2, (
            scroll_area_h - shape_h
        ) / 2
...
def get_main_app(argv=None):
    ...
    argparser.add_argument("--images", dest="image_dir")
    ...
    argparser.add_argument("--annotations", dest="save_dir")
